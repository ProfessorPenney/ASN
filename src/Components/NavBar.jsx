   ...
   return (
      <DivMain>
         <NavEl animate={mobileMenu}>
            <H2>Projects</H2>
            <A href='' style={{ transition: 'opacity 1.3s 0.1s' }}>
               <Li>
                  Title1
                  <HrUnderline />
               </Li>
            </A>
            <A href='' style={{ transition: 'opacity 1.3s 0.2s' }}>
               <Li>
                  Title2
                  <HrUnderline />
               </Li>
            </A>
            <A href='' style={{ transition: 'opacity 1.3s 0.3s' }}>
               <Li>
                  Title3
                  <HrUnderline />
               </Li>
            ...
            {/* {projects.map(({ id, title, link }) => (
               <A href={link} key={id} style={{ transition: `opacity 1.3s ${id * 0.1}s` }}>
                  <Li>
                     {title}
                     <HrUnderline />
                  </Li>
